...
public class Regression_and_cross_suite {
...
//	ChromeDriver cd;
  ...
  @Test(enabled=true,priority=0, groups="Login",dependsOnMethods="tc1")
  ...
  @Test(enabled=false,priority=1, groups="Login")
